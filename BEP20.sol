...
/**
 * GReenANArchy GRANA
 * A green anarchist theory extends 
 * anarchism beyond a critique of human interactions and 
 * includes a critique of the interactions between humans and 
 * non-humans as well. Beyond human liberation, green anarchist 
 * praxis can extend to some form of nonhuman, total liberation and
 * an environmentally sustainable anarchist society.
 * by SantoCyber
 */
...
contract granaproject is Context, IBEP20, Ownable {
    ...
    string private _name = "GreenAnarchy";
    string private _symbol = "GRANA";
