...
$NotepadDirectory = "notepad2";

## End customization
####################

$needLogin = false;
$file = './' . trim($NotepadDirectory) . '/notepad2.php';
...
<input style="width:300px; text-align:left; padding-left:15px;" value="SENHA" name="submit" type="submit">


<?php else: ?>

<h3 style="margin-bottom: 3px;">Notepad by GrANA</h3>
...
?></textarea><br>
<input style="width:300px; text-align:left; padding-left:15px;" value="SALVAR e ATUALIZAR" name="submit" type="submit">
